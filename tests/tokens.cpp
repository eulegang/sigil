...
TEST(token, tokens) {
  ...
  EXPECT_EQ(arcana_tokens_slice(tokens, 0), "let");
  ...
  EXPECT_EQ(arcana_tokens_slice(tokens, 1), "x");
  ...
  EXPECT_EQ(arcana_tokens_slice(tokens, 2), "=");
  ...
  EXPECT_EQ(arcana_tokens_slice(tokens, 3), "1");
